...
const config = {
  ...
  organizationName: 'morethanmin', // Usually your GitHub org/user name.
  projectName: 'react-cursorify', // Usually your repo name.
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        style: 'dark',
        copyright: `Copyright © ${new Date().getFullYear()} react cursorify. Built with Docusaurus.`,
      },
      prism: {
